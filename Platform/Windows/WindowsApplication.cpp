...
namespace My
{
	GfxConfiguration cfg(8, 8, 8, 8, 32, 0, 0, 960, 540, L"Game Engine from TaoGod(Windows)");
	WindowsApplication g_App(cfg);
...
namespace My
{
	int My::WindowsApplication::Initialize()
	{
		...
		wc.lpszClassName = _T("GameEngineFromTaoGod");
		...
		hWnd = CreateWindowExW(0,
			L"GameEngineFromTaoGod",      // name of the window class
